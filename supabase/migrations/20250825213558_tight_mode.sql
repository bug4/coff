...
DROP POLICY IF EXISTS "Anyone can update likes" ON confessions;
...
DROP INDEX IF EXISTS confessions_created_at_idx;
DROP INDEX IF EXISTS confessions_likes_idx;
...
VALUES ('Heaven.xyz', 'Welcome to the Certificate of Forgiveness! This is a test confession to verify everything is working.', 'Minor', 'heaven', 5);